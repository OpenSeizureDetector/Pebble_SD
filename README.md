...
So it is an ideal platform for an accelerometer based seizure detector
similar to the Arduino based one I made in 2013.   For more details see the (OpenSeizuredetector)[http://openseizuredetector.org.uk] web site.
